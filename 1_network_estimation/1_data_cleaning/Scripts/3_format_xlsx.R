...
# fix_names()
#
# applies name corrections using a lookup table
# ─────────────────────────────────────────────────────────────────────────────
...
name_corrections <- tribble(
  ...
  "Coahuila",             "Cuatro Cienegas",                             "Cuatrocienegas",
  ...
  "Guanajuato",     "Dolores Hidalgo Cuna De La Independencia Nacional", "Dolores Hidalgo",
