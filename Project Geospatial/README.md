...
3. **Multi-event expansion.** Retrieve and process ShakeMap rasters for additional seismic events using the existing pipeline.
   - Included ten earthquakes in Mexico with >=6.5Mw between 2014-2022

4. **Data Merging.** Cleaned remittance and INEGI data, merged together to construct final panel dataset
